...
public class FourthTutorial : BaseTutorial {
	...
	public override void Step1 ()
	{
		...
		TemplateSelectTutorial (new int[]{14,19,23,17,12}, true, StatementShadow.Off, StatementShadow.Off, 2.27f, StringConstants.GetTextTutorial(StringConstants.Level.Fourth,0));
	}
	
	public override void Step2 ()
	{
		TemplateSelectTutorial (new int[]{12,7,1}, false, StatementShadow.Off, StatementShadow.Off, 14, StringConstants.GetTextTutorial(StringConstants.Level.Fourth,1));
	}
