...
public class FirstTutorial: BaseTutorial {
	...
	public override void Step1 ()
	{
		...
		TemplateSelectTutorial (new int[]{17,12,7}, false, StatementShadow.Off, StatementShadow.Off, 14, StringConstants.GetTextTutorial(StringConstants.Level.First,0));
	}

	public override void Step2 ()
	{
		TemplateSelectTutorial (new int[]{10,6,7,8,14}, false, StatementShadow.Off, StatementShadow.Off, 14, StringConstants.GetTextTutorial(StringConstants.Level.First,1));
	}
	
	public override void Step3()
	{
		TemplatePopupTutorial (false, StatementShadow.Off, StatementShadow.Off, 10, StringConstants.GetTextTutorial(StringConstants.Level.First,2), new Vector2 (-3.4f, 8.5f), true);
...
//		GamePlay.gameUI.panels[0].color = new Color(1f,1f,1f,1f);
	...
	{
		TemplatePopupTutorial (true, StatementShadow.Off, StatementShadow.Off, 10, StringConstants.GetTextTutorial(StringConstants.Level.First,4), new Vector2(3.4f,8.5f), true);
...
//		GamePlay.gameUI.panels[2].color = new Color(1f,1f,1f,1f);
	...
	{
		TemplatePopupTutorial (true, StatementShadow.Off, StatementShadow.Off, 10, StringConstants.GetTextTutorial(StringConstants.Level.First,3), new Vector2(0f,7.5f), true);
...
//		GamePlay.gameUI.panels[1].color = new Color(1f,1f,1f,1f);
	...
	{
		TemplatePopupTutorial (true, StatementShadow.Off, StatementShadow.Off, 10, StringConstants.GetTextTutorial(StringConstants.Level.First,5), new Vector2 (-3.4f, 8.5f), true);
		GamePlay.gameUI.targetName.color = new Color(GamePlay.gameUI.targetName.color.r,
		                                             GamePlay.gameUI.targetName.color.g,
		                                             GamePlay.gameUI.targetName.color.b,
		                                             1f);
