...
public class SixthTutorial : BaseTutorial {
	...
	public override void Step1()
	{
		...
		TemplatePopupTutorial (false, StatementShadow.Off, StatementShadow.Off, 10, StringConstants.GetTextTutorial(StringConstants.Level.Six, 0), new Vector2(0,8.5f), true);
...
//		GamePlay.gameUI.panels[1].color = new Color(1f,1f,1f,1f);
	...
	{
		TemplatePopupTutorial (true, StatementShadow.Off, StatementShadow.Off, 10, StringConstants.GetTextTutorial(StringConstants.Level.Six, 1), new Vector2(0,8.5f), false);
	}
}
